...
namespace Blog.Core.Model.Models
{
    public class MyContext
    {
        ...
        private static string _connectionString = File.Exists(@"D:\my-file\dbCountPsw1_1.txt") ? File.ReadAllText(@"D:\my-file\dbCountPsw1_1.txt").Trim() : "server=.;uid=sa;pwd=123;database=WMBlogDB";
